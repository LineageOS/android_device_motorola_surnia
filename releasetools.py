...
def AddAssertion(info):
  ...
  info.script.AppendExtra('if getprop("ro.boot.fsg-id") == "" then')
...
def ReplaceApnList(info):
  ...
  info.script.AppendExtra('if getprop("ro.boot.carrier") == "sprint"')
  ...
  info.script.AppendExtra('run_program("/sbin/sh", "-c", "mv /system/etc/cdma/eri-sprint.xml /data/eri.xml")');
  info.script.AppendExtra('endif;')
  info.script.AppendExtra('if getprop("ro.boot.fsg-id") == "virgin" then')
  info.script.AppendExtra('run_program("/sbin/sh", "-c", "mv /system/etc/cdma/apns-conf-vmob.xml /system/etc/apns-conf.xml")');
  info.script.AppendExtra('run_program("/sbin/sh", "-c", "mv /system/etc/cdma/eri-vmob.xml /data/eri.xml")');
  info.script.AppendExtra('endif;')
  ...
  info.script.AppendExtra('run_program("/sbin/sh", "-c", "mv /system/etc/cdma/eri-boost.xml /data/eri.xml")');
  info.script.AppendExtra('endif;')
  info.script.AppendExtra('endif;')
